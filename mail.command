...
for TESTDIR in ~/Library/Mobile\ Documents/com~apple~mail/data/V4/Signatures/ ~/Library/Mobile\ Documents/com~apple~mail/data/V3/MailData/Signatures/ ~/Library/Mobile\ Documents/com~apple~Mail/Data/MailData/Signatures/ ~/Library/Mobile\ Documents/Mail/Data/MailData/Signatures/ ~/Library/Mail/V4/MailData/Signatures/ ~/Library/Mail/V3/MailData/Signatures/ ~/Library/Mail/V2/MailData/Signatures/
  do
  if [ -d "$TESTDIR" ]; then
    cd "$TESTDIR"
